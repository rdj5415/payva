...
class TenantAdmin:
    ...
    async def update(self, tenant_id: UUID4, tenant_data: TenantUpdate) -> Optional[Tenant]:
        """Update a tenant.
...
class UserAdmin:
    ...
    async def get_tenant_users(self, tenant_id: UUID4, skip: int = 0, limit: int = 100) -> List[User]:
