...
async def test_notification(
    ...
    risk_level: str = Body("medium", description="Risk level (negligible, low, medium, high, critical)"),
    ...
    try:
        ...
        return NotificationResponse(
            ...
            message=(
                ...
                if success else
                f"Failed to send test notification to {recipient}"
            ),
        )
...
async def send_anomaly_notification(
    anomaly_id: UUID4,
    force: bool = Query(False, description="Force sending even if notification was already sent"),
    ...
    try:
        ...
        return NotificationResponse(
            ...
            message=(
                ...
                if success else
                f"Failed to send notification for anomaly {anomaly_id}"
            ),
        )
