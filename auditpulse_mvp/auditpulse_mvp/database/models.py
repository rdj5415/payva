...
class Tenant(Base):
    ...
    enable_ml_engine: Mapped[bool] = mapped_column(
        Boolean, default=True, nullable=False
    )
    enable_gpt_explanations: Mapped[bool] = mapped_column(
        Boolean, default=True, nullable=False
    )
    enable_demo_mode: Mapped[bool] = mapped_column(
        Boolean, default=False, nullable=False
    )
