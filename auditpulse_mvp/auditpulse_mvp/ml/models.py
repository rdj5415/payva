...
async def update_ml_model_parameters(
    ...
    try:
        ...
        model_files = [
            f for f in os.listdir(tenant_models_dir) 
        ...
        if "threshold" in params:
            ...
            if hasattr(model, "contamination"):
                ...
                logger.warning(f"Model {model_name} does not have a contamination parameter")
        ...
        if "regularization" in params:
            ...
            if hasattr(model, "max_samples"):
                ...
                logger.warning(f"Model {model_name} does not have a max_samples parameter")
        ...
        new_model_path = os.path.join(
            tenant_models_dir, 
            f"{model_name}_updated_{timestamp}.joblib"
        )
