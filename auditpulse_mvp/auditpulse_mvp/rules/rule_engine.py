...
async def update_rule_thresholds(
    ...
    try:
        ...
        if "threshold" in rule_config:
        ...
        elif "parameters" in rule_config and "std_dev_threshold" in rule_config["parameters"]:
            ...
            if "parameters" in rule_config:
                for param_name, param_value in rule_config["parameters"].items():
                    if isinstance(param_value, (int, float)) and "threshold" in param_name.lower():
            ...
            if not adjusted:
                ...
                if adjustment > 0.1:  # If a significant positive adjustment was needed
                    logger.info(f"No threshold found to adjust for {rule_name}, disabling rule")
