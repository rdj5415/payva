...
from auditpulse_mvp.database.models import NotificationTemplate as DBNotificationTemplate
...
class TemplateManager:
    ...
    async def get_template(self, template_id: str, refresh: bool = False) -> Optional[Dict[str, Any]]:
        ...
        async with get_db() as db:
            template = await db.query(DBNotificationTemplate).filter(
                DBNotificationTemplate.template_id == template_id
            ).first()
    ...
    async def render_template(
        ...
        if not template:
            ...
            return {
                ...
                "html_body": f"<p>(Template {template_id} not found)</p>" if include_html else None,
            }
        ...
        try:
            ...
            return {
                ...
                "html_body": f"<p>An error occurred while rendering the notification template.</p>" if include_html else None,
            }
    ...
    async def create_template(
        ...
        async with get_db() as db:
            ...
            if template:
                ...
                template.placeholders = json.dumps(placeholders) if placeholders else None
