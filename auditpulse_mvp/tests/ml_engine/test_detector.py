...
from auditpulse_mvp.ml_engine.detector import MLAnomalyDetector, DEFAULT_ML_SCORE_THRESHOLD
...
class TestMLAnomalyDetector:
    ...
    async def test_process_transaction_no_anomaly(self, detector, mock_transaction):
        ...
        detector.rule_engine.evaluate_transaction.assert_called_once_with(mock_transaction)
    
    async def test_process_transaction_ml_anomaly(self, detector, mock_transaction, mock_db_session):
    ...
    async def test_process_transaction_rule_anomaly(self, detector, mock_transaction, mock_db_session):
    ...
    async def test_process_transaction_ml_error(self, detector, mock_transaction, mock_db_session):
    ...
    async def test_process_transaction_no_ml_model(self, detector, mock_transaction, mock_db_session):
    ...
    async def test_create_anomaly_new(self, detector, mock_transaction, mock_db_session):
    ...
    async def test_create_anomaly_existing(self, detector, mock_transaction, mock_db_session):
    ...
    async def test_create_anomaly_existing_lower_confidence(self, detector, mock_transaction, mock_db_session):
    ...
    async def test_process_transactions_batch(self, detector, mock_transaction, mock_db_session):
