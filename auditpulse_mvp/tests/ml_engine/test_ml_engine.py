...
class TestMLEngineDirectoryManagement:
    ...
    def test_get_tenant_model_directory(self, ml_engine, mock_tenant_id, mock_model_dir):
    ...
    def test_get_latest_model_path_with_models(self, ml_engine, mock_tenant_id, mock_model_dir):
...
class TestMLEngineDataProcessing:
    ...
    def test_prepare_features(self, ml_engine, mock_transactions):
        ...
        expected_columns = [
            "amount", "source", "merchant_name", "category", 
            "day_of_week", "hour_of_day", "month", "day_of_month", 
            "transaction_date"
        ]
...
class TestMLEngineModelTraining:
    ...
    async def test_get_training_data(self, ml_engine, mock_tenant_id, mock_transactions):
    ...
    async def test_get_training_data_not_enough_data(self, ml_engine, mock_tenant_id, mock_db_session):
...
class TestMLEngineInference:
    ...
    async def test_score_transaction(self, ml_engine, mock_tenant_id, mock_transactions):
        ...
        anomalous_score = await ml_engine.score_transaction(mock_tenant_id, anomalous_txn)
    ...
    async def test_batch_score_transactions(self, ml_engine, mock_tenant_id, mock_transactions):
        ...
        # Score the batch
        scores = await ml_engine.batch_score_transactions(mock_tenant_id, transactions_to_score)
...
class TestMLEngineRetraining:
    ...
    async def test_retrain_all_tenant_models(self, ml_engine, mock_tenant, mock_db_session):
    ...
    async def test_retrain_tenant_ml_disabled(self, ml_engine, mock_tenant, mock_db_session):
    ...
    async def test_retrain_tenant_not_enough_data(self, ml_engine, mock_tenant, mock_db_session):
