...
@pytest.mark.asyncio
async def test_statistical_outlier_rule_triggered(mock_historical_transactions, mock_outlier_transaction):
    ...
    context = {
        "historical_transactions": mock_historical_transactions
    }
...
@pytest.mark.asyncio
async def test_rules_engine_get_historical_transactions(db_session, mock_transaction, mock_historical_transactions):
