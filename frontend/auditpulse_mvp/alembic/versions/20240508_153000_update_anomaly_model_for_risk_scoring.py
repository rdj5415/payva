...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "detection_metadata", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.Column("is_resolved", sa.Boolean(), default=False, nullable=False),
        sa.Column(
            "feedback",
            sa.Enum(
                "true_positive", "false_positive", "ignore", name="feedbacktype_new"
            ),
            nullable=True,
        ),
...
def downgrade() -> None:
    ...
    op.create_type(
        "anomalytype_old",
        postgresql.ENUM("rules_based", "ml_based", "manual", name="anomalytype_old"),
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "anomaly_type",
            sa.Enum("rules_based", "ml_based", "manual", name="anomalytype_old"),
            nullable=False,
        ),
