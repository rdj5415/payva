...
class NotificationScheduler:
    ...
    def __init__(self):
        ...
        logger.info(
            f"Notification scheduler initialized with interval: {self._notification_interval} minutes"
        )
        ...
        try:
            while self._is_running:
                ...
                next_run = datetime.now() + timedelta(
                    minutes=self._notification_interval
                )
                logger.info(
    ...
    async def _run_notification_check(self):
        ...
        try:
            ...
            async with get_db() as db:
                notifications_sent = (
                    await notification_service.notify_high_risk_anomalies(db)
                )
