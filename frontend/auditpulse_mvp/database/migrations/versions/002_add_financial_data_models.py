...
def downgrade():
    ...
    op.drop_index('ix_financial_transactions_transaction_id', table_name='financial_transactions')
    ...
    op.drop_index('ix_financial_accounts_plaid_account_id', table_name='financial_accounts')
    op.drop_index('ix_financial_accounts_user_id', table_name='financial_accounts')
    op.drop_table('financial_accounts')
    
    op.drop_index('ix_financial_institutions_plaid_item_id', table_name='financial_institutions')
    op.drop_index('ix_financial_institutions_user_id', table_name='financial_institutions')
