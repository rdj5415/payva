...
def get_scheduler(settings: Settings = Depends(get_settings)) -> Union[AsyncIOScheduler, BackgroundScheduler]:
...
def register_task(
    ...
    **trigger_args: Any
    ...
    logger.info(f"Registering task: {task_id}, trigger: {trigger}, args: {trigger_args}")
