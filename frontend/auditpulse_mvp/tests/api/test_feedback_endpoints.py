...
class TestFeedbackLearningEndpoints:
    ...
    async def test_trigger_immediate_learning(self, app, client, tenant_id):
        ...
        with patch(
            "auditpulse_mvp.api.api_v1.endpoints.learning.get_feedback_learning_scheduler"
    ...
    async def test_get_learning_status_no_config(self, app, client, tenant_id):
        ...
        assert (
            data["detail"]
            == f"No sensitivity configurations found for tenant {tenant_id}"
        )
...
class TestFeedbackLearningAsyncClient:
    ...
    async def test_handling_learning_errors(self, app, tenant_id):
        ...
        mock_scheduler = AsyncMock()
        mock_scheduler.run_immediate_learning.side_effect = Exception(
            "Test learning error"
        )
...
class TestLearningEndpoints:
    ...
    async def test_trigger_learning_now_success(self, mock_db, mock_current_tenant):
        ...
        with patch(
            "auditpulse_mvp.api.api_v1.endpoints.learning.get_feedback_learner"
        ) as mock_get_learner:
    ...
    async def test_get_learning_status(self, mock_db, mock_current_tenant):
        ...
        with patch(
            "auditpulse_mvp.api.api_v1.endpoints.learning.get_tenant_configuration"
        ) as mock_get_config:
            mock_config = {
                "last_learning_run": {
    ...
    async def test_get_feedback_statistics(self, mock_db, mock_current_tenant):
        ...
        with patch(
            "auditpulse_mvp.api.api_v1.endpoints.learning.get_learning_statistics"
        ) as mock_get_stats:
            mock_stats = {
                "total_feedback": 50,
                "rules_based": {
    ...
    async def test_update_learning_schedule(self, mock_db, mock_current_tenant):
        ...
        with patch(
            "auditpulse_mvp.api.api_v1.endpoints.learning.update_tenant_configuration"
